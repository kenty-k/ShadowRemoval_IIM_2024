...
parser.add_argument('--input_dir', default='path of test dir',
    type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='../results/determistic_model',
    type=str, help='Directory for results')
parser.add_argument('--weights', default='../weights/deterministic_model.pth',
