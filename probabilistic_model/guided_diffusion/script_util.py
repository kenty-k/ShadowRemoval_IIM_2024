...
#################################################################################
########################## NAFNet ################################################
from .nafnet import ConditionalNAFNet, ConditionalNAFNetCondFet, ConditionalNAFNetCondFet_


def model_and_diffusion_defaults_deshadow():
    """
    Defaults for image training.
    """
    res = dict(
...
def model_and_diffusion_defaults_deshadow_mask():
    """
    Defaults for image training.
    """
    res = dict(
...
def create_model_and_diffusion_nafnet(
    img_channel,
    learn_sigma,
    diffusion_steps,
    noise_schedule,
...
def create_model_nafnet(
    ...
    return ConditionalNAFNetCondFet(
    # return ConditionalNAFNetCondFet_(
...
def create_model_and_diffusion_nafnet_prepred(
    img_channel,
    learn_sigma,
    diffusion_steps,
    noise_schedule,
