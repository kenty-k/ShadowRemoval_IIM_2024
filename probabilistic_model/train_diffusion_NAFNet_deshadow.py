...
from guided_diffusion.script_util import (
    model_and_diffusion_defaults_deshadow,
...
def main():
    ...
    model, diffusion = create_model_and_diffusion_nafnet(
        **args_to_dict(args, model_and_diffusion_defaults_deshadow().keys())
    )
...
def create_argparser():
    ...
    defaults.update(model_and_diffusion_defaults_deshadow())
